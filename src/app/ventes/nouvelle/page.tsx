              ...
              <CardContent className="p-10 space-y-8">
                <div className="bg-white/5 p-8 rounded-[40px] space-y-6">
                  <div className="flex justify-between items-center">
                    ...
                    <input 
                      type="text" 
                      className="bg-transparent text-right font-black text-lg text-white outline-none w-48 tabular-nums" 
                      value={total} 
                ...
                <div className="bg-white/5 p-8 rounded-[40px] space-y-6">
                  <div className="flex justify-between items-center">
                    ...
                    <input 
                      type="text" 
                      className="bg-transparent text-right font-black text-lg text-white outline-none w-48 tabular-nums border-b border-white/10 focus:border-[#D4AF37] transition-colors" 
                      value={avance} 
