    ...
    <div className="pdf-a5-portrait bg-white flex flex-col p-[8mm] relative h-[210mm] max-h-[210mm] overflow-hidden">
      ...
      <div className="mb-8 flex-1">
        ...
        <table className="w-full text-[9px]">
          <thead className="bg-[#6a8036] text-white border-b border-slate-900"><tr><th className="p-2 text-left uppercase tracking-widest">Date</th><th className="p-2 text-right uppercase tracking-widest">Montant</th></tr></thead>
          <tbody>
