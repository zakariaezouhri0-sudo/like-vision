      ...
      <div className="space-y-8">
              ...
              <DialogContent className="max-w-md">
                ...
                <div className="space-y-4 py-4">
                  <div className="grid grid-cols-2 gap-4">
                    ...
                    <div className="text-sm text-right">{formatCurrency(soldeInitial)}</div>
                    <div className="text-sm font-medium">Total Ventes:</div>
                    <div className="text-sm text-right">{formatCurrency(totalVentes)}</div>
                    <div className="text-sm font-medium">Total Dépenses:</div>
                    <div className="text-sm text-right">-{formatCurrency(totalDepenses)}</div>
                    <div className="text-sm font-medium">Total Apports:</div>
                    <div className="text-sm text-right">{formatCurrency(totalApports)}</div>
                    <div className="pt-2 border-t font-bold text-primary">Solde Théorique:</div>
                    <div className="pt-2 border-t font-bold text-primary text-right">{formatCurrency(soldeTheorique)}</div>
                  </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <Card className="bg-primary text-primary-foreground">
            ...
            <CardContent>
              <div className="text-3xl font-bold">{formatCurrency(soldeTheorique)}</div>
          ...
          <Card className="border-l-4 border-l-green-500">
            ...
            <CardContent>
              <div className="text-2xl font-bold text-green-600">{formatCurrency(totalVentes + totalApports)}</div>
