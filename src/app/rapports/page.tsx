          ...
          <div className="flex flex-row items-center gap-2 overflow-x-auto pb-1 md:pb-0">
            <Popover>
              <PopoverTrigger asChild>
                <Button variant="outline" className="h-11 px-3 md:px-4 rounded-xl font-black text-[10px] uppercase border-primary/20 bg-white whitespace-nowrap">
            ...
            <Button onClick={handleExportCSV} className="h-11 px-3 md:px-4 rounded-xl font-black text-[10px] uppercase shadow-lg bg-green-600 hover:bg-green-700 whitespace-nowrap">
              <FileSpreadsheet className="mr-1.5 h-4 w-4" /> EXCEL
            </Button>
            
            <Button onClick={() => window.print()} variant="outline" className="h-11 px-3 md:px-4 rounded-xl font-black text-[10px] uppercase border-primary/20 bg-white whitespace-nowrap">
