      ...
      <div className="space-y-8 pb-10">
        <div className="bg-white p-8 rounded-[60px] border shadow-xl shadow-slate-200/50 flex flex-col lg:flex-row justify-between items-center gap-6">
          ...
          <div className="flex items-center gap-2 bg-slate-50 p-2 rounded-full border shadow-inner">
            ...
            <Button onClick={() => router.push(`/rapports/print/journalier?date=${format(dateRange.from, "yyyy-MM-dd")}`)} className="h-12 px-8 rounded-full font-black text-[10px] uppercase shadow-lg bg-[#D4AF37] text-[#0D1B2A] hover:bg-[#0D1B2A] hover:text-white transition-all"><FileText className="mr-2 h-4 w-4" /> JOURNALIER</Button>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {[ 
            ...
            { l: "Dépenses", v: -stats.expenses, c: "text-red-500" }, 
