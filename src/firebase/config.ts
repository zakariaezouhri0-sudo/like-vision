...
// Si Vercel pointe sur le projet vide (like-vision-187e1), on force le retour sur le projet DATA
const activeProjectId = (VERCEL_PROJECT_ID === "like-vision-187e1") ? DATA_PROJECT_ID : (VERCEL_PROJECT_ID || DATA_PROJECT_ID);
